 ...
 *  开始下拉时提示字串
 */
@property (nonatomic, copy) NSString *refreshStringNormal;


/**
 *  下来没放松时提示字串
 */
@property (nonatomic, copy) NSString *refreshStringPulling;


/**
 *  加载中提示字串
 */
@property (nonatomic, copy) NSString *refreshStringLoading;
