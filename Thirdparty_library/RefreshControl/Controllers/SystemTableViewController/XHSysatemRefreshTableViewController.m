...
- (void)setupRefreshControl {
    if (!_customRefreshControl) {
        ...
        _customRefreshControl.refreshStringNormal=self.refreshStringNormal;
        _customRefreshControl.refreshStringPulling=self.refreshStringPulling;
        _customRefreshControl.refreshStringLoading=self.refreshStringLoading;
    }
}
