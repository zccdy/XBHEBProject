...
- (void)setupRefreshControl {
    if (!_refreshControl) {
        ...
        _refreshControl.refreshStringNormal=self.refreshStringNormal;
        _refreshControl.refreshStringPulling=self.refreshStringPulling;
        _refreshControl.refreshStringLoading=self.refreshStringLoading;
    }
}
